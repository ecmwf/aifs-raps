...
file_pattern = "gpu_?_memory_usage_megabytes"

# Find all matching files
files = system(sprintf("ls %s/%s", root_dir, file_pattern))
file_total_memory = sprintf("%s/gpu_memory_total_megabytes", root_dir)
...
set ylabel "GPU Memory Usage (MB)"
set grid
set key outside
...
# Plot data
plot_command = "plot file_total_memory using x_axis_column:2 with lines title 'Total GPU memory', "
